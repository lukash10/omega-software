<template>
  ...
  <div id="sidebarNav">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion d-flex" style="background-color: rgb(0 74 55);" id="accordionSidebar">

    <!-- Sidebar - Brand -->
    <router-link to="/dashboard" class="sidebar-brand d-flex align-items-center justify-content-center">
      <div class="sidebar-brand-icon w-50" >
    ...
    <li class="nav-item active">
      <router-link to="/dashboard" class="nav-link" style="text-align: center;">
    ...
    <!-- Heading -->
    <div class="sidebar-heading color-white">Área Principal</div>

    <li class="nav-item">
      <a class="color-white nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse1"
        aria-expanded="true" aria-controls="collapse1">
        <i class="color-white fa-regular fa-wallet"></i>
        <span>Financeiro</span>
      </a>

      <div id="collapse1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/cadtags" class="collapse-item">Royalties</router-link>
          <router-link to="/listtags" class="collapse-item">Boletos/NF</router-link>
        </div>
      </div>
    </li>
      
    <li class="nav-item">
      <a class="color-white nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse4"
        aria-expanded="true" aria-controls="collapse4">
        <i class="color-white fa-solid fa-earth-americas"></i>
        <span>Gestão Comercial</span>
      </a>

      <div id="collapse4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/cadpolos" class="collapse-item">CRM</router-link>
          <router-link to="/listpolos" class="collapse-item">Contratos</router-link>
        </div>
      </div>
    </li>

    <li class="nav-item">
      <a class="color-white nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse5"
        aria-expanded="true" aria-controls="collapse4">
        <i class="color-white fa-solid fa-building"></i>
        <span>Meu Negócio</span>
      </a>

      <div id="collapse5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/cadpolos" class="collapse-item">Plano de Negócios</router-link>
        </div>
      </div>
    </li>

    <li class="nav-item">
      <a class="color-white nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseD"
        aria-expanded="true" aria-controls="collapse4">
        <i class="color-white fa-solid fa-file"></i>
        <span>Meus Documentos</span>
      </a>

      <div id="collapseD" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/cadpolos" class="collapse-item">Documentos</router-link>
        </div>
      </div>
    </li>
    ...
    <hr class="sidebar-divider">
    <!-- Heading -->
    <div class="sidebar-heading color-white">Administração</div>

    <li class="nav-item">
      <a class="color-white nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsenot"
        aria-expanded="true" aria-controls="collapsenot">
        <i class="color-white fa-solid fa-newspaper"></i>
        <span>Cadastrar Notícias</span>
      </a>

      <div id="collapsenot" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/cadastrarnoticia" class="collapse-item">Cadastrar Notícia</router-link>
          <router-link to="/listarnoticia" class="collapse-item">Listar Notícias</router-link>
        </div>
      </div>
    </li>

    <li class="nav-item">
      <a class="color-white nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsetag"
        aria-expanded="true" aria-controls="collapsetag">
        <i class="color-white fa-regular fa-tags"></i>
        <span>Tags</span>
      </a>

      <div id="collapsetag" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/cadtags" class="collapse-item">Cadastrar Tags</router-link>
          <router-link to="/listtags" class="collapse-item">Listar Tags</router-link>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      <a class="color-white nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse6"
        aria-expanded="true" aria-controls="collapse6">
        <i class="color-white fa-solid fa-users"></i>
        <span>Minha Conta</span>
      </a>

      <div id="collapse6" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/cadusers" class="collapse-item">Administrar Conta</router-link>
        </div>
      </div>
    </li>

    <div class="d-flex" style="justify-content:center">
      <div class="mb-2" style="position:absolute;bottom:0;float: left;">
        <button  @click="limparStorage()" class="btn"><i class="color-white fa-solid fa-arrow-right-from-bracket"></i><span class="color-white">Logout</span></button>
      </div>
    </div>
...
export default {
    ...
    mounted(){
      ...
      toggle.addEventListener('click', ()=>{
        ...
        if (!nav.classList.contains('showw')){
...
@media only screen and (max-width: 600px){
    ...
    .menu_mobile{
        ...
        box-shadow: 0px 0px 0px 1px rgb(43 122 23 / 38%);
